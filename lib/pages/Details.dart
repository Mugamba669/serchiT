            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  // image: box.get(widget.post.docfirstname) != null
                  //      DecorationImage(
                  //         fit: BoxFit.cover,
                  //         colorFilter: const ColorFilter.mode(
                  //             Colors.black45, BlendMode.darken),
                  //         image: MemoryImage(box.get(widget.post.docfirstname)),
                  //       )
                    image:   DecorationImage(
                          fit: BoxFit.cover,
                          colorFilter: ColorFilter.mode(
                              Colors.black45, BlendMode.darken),
                          image: AssetImage(Localfiles.lost),
                        ),
                ),
                child: Center(
